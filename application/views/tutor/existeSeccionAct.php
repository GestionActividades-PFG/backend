...
<head>
    <meta charset="UTF-8">
    <title>Gestionar inscripcion seccion - Tutor</title>
...
<div class="container caja">
    ...
    <div class="row">
        ...
        <article class="col-md-9 articulo">
            <div>
                <h3>Inscribir seccion a la actividad</h3>
                <div class="alert alert-warning">
                    <h4>¡ATENCIÓN!</h4>
                    <p>Tu seccion ya se ha apuntado a esta actividad. ¿Deseas borrar su inscripción?</p>
                </div>


                <?php
                    echo form_open("Tutor/operacionActSeccion");
                    echo form_hidden('actividad',$_GET['actividad']);
                    echo form_submit('borrar','Si, quiero borrar la inscripción', 'class="btn btn-success"');
                    echo form_submit('volver','No, quiero volver a la pantalla anterior', 'class="btn btn-success"');
                    echo form_close();
                ?>
            </div>
        </article>
