    ...
    <div class="row">
        ...
        <article class="col-md-9 articulo">
            <div class="form-group">
                <?= form_open('Gestor/borrarPerfilExistente')?>
                <div class="alert alert-warning">
                    <p>Si borras el perfil, se eliminaran tambien las asignaciones de los perfiles a los usuarios.</p>
                </div>
                <?php echo form_hidden('id',$_GET['perfil'])?>

                <?php echo form_submit('enviar','Si, borrar el perfil','class="btn btn-success"')?>
                <?php echo form_submit('volver','No, volver al menu anterior','class="btn btn-success"')?>
                <?= form_close()?>
            </div>
