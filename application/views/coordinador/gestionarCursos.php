...
<head>
    ...
    <title>Gestionar cursos - Actividades EVG</title>
    <meta charset="UTF-8">
    ...
    <div class="container "  >
        <div class="row " >
            ...
            <div class="col-sm-8 col-md-8" id="cuerpo">
                ...
                $sql_cursos = "SELECT act_cursos.*, act_categorias.*
                                FROM act_cursos INNER JOIN act_categorias
                ...
                if($query_cursos->num_rows()){
                    ...
                    foreach($query_cursos->result() as $fila_cursos){
                        echo '<tr>';
                        echo '<td>'.$fila_cursos->nombreCurso.'</td>';
                        echo '<td>'.$fila_cursos->idCategoria." - ".$fila_cursos->nombreCategoria.'</td>';
                        echo '<td><a href="'.base_url().'index.php/Coordinador/menuModificarCursos?curso='.$fila_cursos->codCurso.'&categoria='.$fila_cursos->idCategoria.'">Modificar</a></td>';
                        echo '<td><a href="'.base_url().'index.php/Coordinador/menuBorrarCurso?curso='.$fila_cursos->codCurso.'">Borrar</a></td>';
                        echo '</tr>';
                    }
                    echo '</tbody>';
                    echo '</table>';
                    ...
                    echo '<p>No hay cursos creados.</p>';
                    echo '</div>';
                }
                ?>
            </div>
