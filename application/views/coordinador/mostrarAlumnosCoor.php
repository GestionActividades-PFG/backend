...
<head>
    ...
    <meta charset="UTF-8">
    <title>Mirar alumnos inscritos - Actividades EVG</title>
    ...
    <div class="container "  >
        <div class="row " >
            ...
            <div class="col-sm-8 col-md-8" id="cuerpo">
                <h3>Mostrar alumnos inscritos a actividades</h3>
                ...
                if($query->num_rows()){
                    echo '<label>Selecciona el momento</label>';
                    ...
                    echo '<p>No puedes generar PDF porque no hay momentos creados.</p>';
                    echo '</div>';
