...
<head>
    ...
    <title>Crear curso - Actividades EVG</title>
    <meta charset="UTF-8">
    ...
    <div class="container "  >
        <div class="row " >
            ...
            <div class="col-sm-8 col-md-8" id="cuerpo">
                <h3>Crear curso</h3>
                <?= form_open('Coordinador/crearCurso')?>
                <div class="form-group">
                    <label>Nombre del curso</label>
                    <?php
                        echo form_input('nombreCurso','','class="form-control" required');
                    ?>
                    ...
                    <?php
                        ...
                        if($query_categorias->num_rows()){
                            foreach($query_categorias->result() as $row_cat){
                                $categorias[$row_cat->idCategoria] = $row_cat->idCategoria." - ".$row_cat->nombreCategoria;
                            }
                            echo form_dropdown('categoria',$categorias,'','id="lista_momentos" class="form-control"');
                            echo form_submit('enviar','Crear curso','class="btn btn-success buttons-separator"');
                        }
                        else{
                            echo '<div class="alert alert-danger">';
                            echo '<p>No hay categorias creadas. Para crear cursos, necesitas crear primero las categorias.</p>';
                            echo '</div>';
                        }
