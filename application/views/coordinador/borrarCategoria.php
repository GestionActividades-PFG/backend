...
<head>
    ...
    <title>Borrar categoria - Actividades EVG</title>
    <meta charset="UTF-8">
        ...
        <div class="row " >
            ...
            <div class="col-sm-8 col-md-8" id="cuerpo">
                ...
                <div class="alert alert-warning">
                    <p>Si borras la categoria, borraras los cursos enlazados, las actividades y las inscripciones enlazadas a esas actividades.</p>
                </div>
                <?= form_open('Coordinador/borrarCategoria')?>
                <?php
                echo form_hidden('idCategoria',$_GET["categoria"]);
                echo form_submit('borrar','Si, quiero borrar la categoria','class="btn btn-success"');
