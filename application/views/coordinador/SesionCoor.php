...
<html lang="en">
    <head>
        ...
        <title>Panel</title>
        <meta charset="UTF-8">
        <title>Coordinador - Actividades EVG</title>
                ...
                <div class="col-sm-8 col-md-8" id="cuerpo">
                    <?php
                        if(isset($_GET['correcto'])){
                            ...
                            if($_GET['correcto']=="actividad"){
                                echo '<p>Ya se ha creado la actividad con éxito.</p>';
                            }
                            if($_GET['correcto']=="curso"){
                                echo '<p>Ya se ha creado el curso con éxito.</p>';
                            }
                            echo '</div>';
                        }
                    ?>
