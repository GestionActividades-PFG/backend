...
<head>
    ...
    <title>Borrar momento - Actividades EVG</title>
    <meta charset="UTF-8">
    ...
    <div class="container "  >
        <div class="row " >
            ...
            <div class="col-sm-8 col-md-8" id="cuerpo">
                <h3>Borrar momento</h3>
                <div class="alert alert-warning">
                    <p>Si borras el momento, borraras la actividad y las inscripciones enlazadas a esas actividades.</p>
                </div>
                <?= form_open('Coordinador/borrarMomento')?>
                <?php
                    echo form_hidden('idMomento',$_GET["momento"]);
                    echo form_submit('borrar','Si, quiero borrar el momento','class="btn btn-success"');
